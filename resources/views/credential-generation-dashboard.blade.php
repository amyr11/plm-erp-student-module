...
<div wire:init="$refresh">
    <x-app-layout>
        ...
        <div x-data="{ activeTab: 'student-portal-account' }">
                ...
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="student-portal-account-tab"
                            ...
                            aria-controls="student-portal-account" aria-selected="true">Student Portal Account</button>
                    </li>
                    ...
                    <li class="me-2" role="presentation">
                        <button
                            ...
                            id="plm-email-tab" data-tabs-target="#plm-email" type="button" role="tab"
                            aria-controls="plm-email" aria-selected="false">PLM Email</button>
                    </li>
                    <!-- End PLM Email -->
                </ul>
            </nav>
            <!-- End Tab -->
            <!-- Tab Contents -->
            <main id="default-tab-content">
                <!-- Student Portal Account -->
                <section class="hidden p-4 rounded-lg" id="student-portal-account" role="tabpanel"
                    aria-labelledby="student-portal-account-tab">
                    <!-- Buttons Container -->
                    <div class="flex items-center justify-between mb-4">
                        <!-- "Email all" Button -->
                        <livewire:email-all-button />
            ...
            justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] 
                ...
                <!-- End Student Portal Account -->
                <!-- PLM Email -->
                <section class="hidden p-4 rounded-lg" id="plm-email" role="tabpanel" aria-labelledby="plm-email-tab">
                    <!-- Buttons Container -->
                    <div class="flex items-center justify-between mb-4">
                        <!-- "Email all" Button -->
